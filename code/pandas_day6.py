...
# print("右表右表右表右表右表右表右表右表右表右表右表")
params = pd.read_csv('pandas/data/air_quality_parameters.csv')  # params左边表  aq右边表
# print(params.shape)
# print(params.head(7))
...
# merged = aq.merge(
#     params,
#     left_on="parameter",     # 左边这张表，用哪一列去求配
...
# print("lostlostlostlostlostlostlostlostlostlostlostlostlostlost")
...
# print(kept.to_csv('E:\OB\projects\DEMO\Knowledge\博一\量化交易\python-for-quant\看看left.csv'))
